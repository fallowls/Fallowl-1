...
- **Fix Required**: Execute SQL to add a unique constraint to the `settings` table: `ALTER TABLE settings ADD CONSTRAINT settings_tenant_key_unique UNIQUE (tenant_id, key);`
